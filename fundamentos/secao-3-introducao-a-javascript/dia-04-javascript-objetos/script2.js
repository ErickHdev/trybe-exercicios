let order = {
  ...
  function orderModifier(order) {
    return console.log(`Olá, ${order.name}, o valor totral de seu pedido de ${Object.keys(order.order.pizza)} e ${order.order.drinks.coke.type} é R$ ${order.payment.total},00`)
  }
